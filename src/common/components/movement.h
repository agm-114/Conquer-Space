...
<<<<<<< HEAD
                ...
                < < < < < < < < HEAD : src / common / components /
                                       ...
                                       Orbit(kilometer semi_major_axis, double eccentricity, radian inclination,
                                             radian LAN, radian w, radian M0)
                    : eccentricity(eccentricity),
                semi_major_axis(semi_major_axis), inclination(std::fmod(inclination, PI)), LAN(std::fmod(LAN, TWOPI)),
                w(w), M0(M0), v(M0), epoch(0), reference_body(entt::null) {} == == == ==
                ...
                >>>>>>>> pr_8 : src / common / components /
                                ...
                                Orbit(kilometer semi_major_axis, double eccentricity, radian inclination, radian LAN,
                                      radian w, radian M0, entt::entity reference)
                    : eccentricity(eccentricity),
                semi_major_axis(semi_major_axis), inclination(std::fmod(inclination, PI)), LAN(std::fmod(LAN, TWOPI)),
                w(w), M0(M0), v(M0), epoch(0), reference_body(reference) {}
            ...
            inline std::ostream& operator<<(std::ostream& outs, const Orbit& orb) {
                return outs << "(a=" << orb.semi_major_axis << ", e=" << orb.eccentricity << ", i=" << orb.inclination
                            << ", LAN=" << orb.LAN << ", w=" << orb.w << ", GM=" << orb.GM << ", v=" << orb.v
                            << ", M0=" << orb.M0 << ", t=" << orb.epoch << ", ref=" << (uint32_t)orb.reference_body
                            << ")";
            }
            == == == = Orbit(types::degree _trueAnomaly, types::astronomical_unit _semiMajorAxis, double _eccentricity,
                             types::degree _argument, double _gravparam)
                : theta(_trueAnomaly),
...
>>>>>>> pr_4
                ...
                inline Vec3AU toVec3AU(const Orbit& orb, radian theta) {
                    glm::dvec3 vec =
                        OrbitToVec3(orb.semi_major_axis, orb.eccentricity, orb.inclination, orb.LAN, orb.w, theta);
                    return vec / KmInAu;
                }
