                    ...
                    void ScriptUniverseGenerator::Generate(Universe & universe) {
                        == == ==
                            ...
                            script_engine.set_function("random_normal_int", [&gen](int mean, int sd) {
                                ...
                                boost::variate_generator<boost::mt19937&, boost::normal_distribution<>> var_nor(gen,
                                                                                                                nd);
...
<<<<<<< HEAD
                            ...
                            == == == = script_engine.set_function(
                                         "set_orbit", [&](entt::entity orbital_entity, double distance, double theta,
                                                          double eccentricity, double argument) {
                                             cqspt::Orbit& orb = universe.emplace<cqspt::Orbit>(
                                                 orbital_entity, theta, distance, eccentricity, argument, 40);
...
>>>>>>> pr_8
                            ...
                            script_engine.set_function(
                                "create_factory", [&](entt::entity city, entt::entity recipe, float productivity) {
                            ...
                            script_engine.set_function(
                                "create_ship", [&](entt::entity civ, entt::entity orbit, entt::entity starsystem) {
                                    ...
                                    cqspt::Orbit& orbship = universe.emplace<cqspt::Orbit>(
                                        ship, orb.theta, orb.semiMajorAxis, orb.eccentricity, orb.argument, 80);
