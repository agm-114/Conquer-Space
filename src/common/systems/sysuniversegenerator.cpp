    ...
    void ScriptUniverseGenerator::Generate(Universe & universe) {
        == == == = void conquerspace::common::systems::universegenerator::ScriptUniverseGenerator::Generate(
            ...
            script_engine.set_function(
                "is_player", [&](entt::entity civ) { return static_cast<bool>(universe.all_of<cqspc::Player>(civ)); });

            script_engine.set_function("add_planet_habitation",
            ...
            script_engine.set_function("create_mine",
                                       [&](entt::entity city, entt::entity resource, int amount, float productivity) {
