...
<<<<<<< HEAD
        ...
        == == == = namespace cqsp::common::actions {
            ...
            /// <param name="builder"></param>
            /// <returns>The factory entity created, entt::null if it's not possible.</returns>
            Node OrderConstructionFactory(Node & city, Node & market, Node & recipe, Node & builder,
                                          int productivity = 1);
            ...
            >>>>>>>> pr - 292
                : src /
                  ...
                  factoryconstructaction.h
                      ...
                      /// <returns>The factory entity created, entt::null if it's not possible.</returns>
                      entt::entity
                      OrderConstructionFactory(cqsp::common::Universe & universe, entt::entity city,
                                               entt::entity market, entt::entity recipe, int productivity,
                                               entt::entity builder);
