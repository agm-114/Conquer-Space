...
<<<<<<< HEAD:src/common/actions/economy/auctionhandler.cpp namespace cqsp::common::actions {
...
<<<<<<< HEAD:src/common/actions/economy/auctionhandler.cpp
        bool SellGood(AuctionHouse& auction_house, Node& agent, Node& good, double price,
                      double quantity) { == == == = bool SellGood(AuctionHouse & auction_house, entity agent,
                                                                  entity good, double price, double quantity) {
>>>>>>> pr_254:src/common/systems/economy/auctionhandler.cpp
