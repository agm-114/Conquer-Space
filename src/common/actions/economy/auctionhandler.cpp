...
<<<<<<< HEAD
<<<<<<< HEAD:src/common/actions/economy/auctionhandler.cpp namespace cqsp::common::actions { using components::AuctionHouse;

    bool
    BuyGood(AuctionHouse& auction_house, Node& agent, Node& good, double price, double quantity) {
    == == == = namespace components = cqsp::common::components;
    using components::AuctionHouse;
    using components::Order;
    using entt::entity;
    namespace cqsp::common::systems {
    bool BuyGood(AuctionHouse& auction_house, entity agent, entity good, double price, double quantity) {
>>>>>>> pr_254:src/common/systems/economy/auctionhandler.cpp
...
<<<<<<< HEAD:src/common/actions/economy/auctionhandler.cpp
        bool SellGood(AuctionHouse & auction_house, Node & agent, Node & good, double price, double quantity) {
            == == == = bool SellGood(AuctionHouse & auction_house, entity agent, entity good, double price,
                                     double quantity) {
>>>>>>> pr_254:src/common/systems/economy/auctionhandler.cpp
...
>>>>>>> pr_254:src/common/systems/economy/auctionhandler.cpp
            == == == = namespace cqsp::common::actions {
                ...
                bool SellGood(AuctionHouse & auction_house, entt::entity agent, entt::entity good, double price,
                              double quantity) {
                    // The place we will put our order if we cannot fufill it
                    auto& sell_order_list = auction_house.sell_orders[good];
