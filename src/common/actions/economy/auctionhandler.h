...
>>>>>>> pr_254:src/common/systems/economy/auctionhandler.h
        ...
        /// placed.</returns>
        bool BuyGood(components::AuctionHouse & auction_house, Node & agent, Node & good, double price,
                     double quantity);
...
<<<<<<< HEAD:src/common/actions/economy/auctionhandler.h
    ...
    == == == = bool SellGood(components::AuctionHouse & auction_house, entt::entity agent, entt::entity good,
