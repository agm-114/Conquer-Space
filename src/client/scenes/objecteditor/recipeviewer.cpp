...
<<<<<<< HEAD
                        ...
                        if (ImGui::IsItemClicked()) {
                            ...
                            ImGui::SetClipboardText(
                                GetUniverse().get<components::Identifier>(in.first).identifier.c_str());
                        }
...
<<<<<<< HEAD
                ...
                if (ImGui::IsItemClicked()) {
                    // Then copy
                    ImGui::SetClipboardText(
                        GetUniverse().get<components::Identifier>(selected_recipe).identifier.c_str());
                }
                if (ImGui::IsItemHovered()) {
                    ImGui::BeginTooltip();
                    ImGui::TextColored(id_copy_color, "Click to copy identifier");
...
>>>>>>> pr_254
                ...
                ImGui::Text("Output");
<<<<<<< HEAD
                ImGui::TextFmt("Output Cost: {}", util::NumberToHumanString(
                                                      GetUniverse().get<components::Price>(recipe_comp.output.entity) *
