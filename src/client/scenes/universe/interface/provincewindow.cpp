...
<<<<<<< HEAD
                                        IndustryTabGenericChild<components::Factory>("Manufacturing Sector",
                                                                                     "Factories", ImVec2(-1, height));
                                        == == == = IndustryTabGenericChild<Factory>("Manufacturing Sector", "Factories",
                                                                                    ImVec2(-1, height));
>>>>>>> pr_254
...
<<<<<<< HEAD
                                        ...
                                        static float LAN = 0;
                                        auto& city_coord =
                                            GetUniverse().get<components::types::SurfaceCoordinate>(current_city);
                                        ...
                                        if (GetUniverse().get<bodies::Body>(city_coord.planet).radius > periapsis) {
                                            ImGui::TextColored(
                                                ...
                                                "Orbit's periapsis is below the planet radius (%f), so it will crash",
                                                periapsis);
                                        }
                                        ImGui::TextFmt(
                                            "Launch Inclination: {}",
                                            components::types::toDegree(components::types::GetLaunchInclination(
                                                city_coord.r_latitude(), azimuth)));
>>>>>>> pr_254
                                    }
                                    ...
                                    void SysProvinceInformation::InfrastructureTab() {
                                        auto& infras =
                                            GetUniverse().get<infrastructure::CityInfrastructure>(current_city);
                                        ...
                                        if (GetUniverse().any_of<infrastructure::Highway>(current_city)) {
                                            ImGui::TextFmt(
                                                "Highway: {}",
                                                GetUniverse().get<infrastructure::Highway>(current_city).extent);
                                        }
                                    }
...
<<<<<<< HEAD
                                        if (ImGui::BeginTable("industry_list_table", 9,
