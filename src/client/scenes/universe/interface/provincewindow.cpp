...
<<<<<<< HEAD
                                ...
                                ImGui::TextFmt("Time: {} {}:{} ({})", GetUniverse().date.ToString(tz_def.time_diff),
                                               hour, GetUniverse().date.GetMinute(), tz_name);
                            }
...
>>>>>>> pr-288
                                                ...
                                                ImGui::TextFmt(
                                                    ...
                                                    (1. - static_cast<double>(pop_segement.employed_amount) /
                                                        ...
                                                        100.);
                                                ImGui::TextFmt("Standard of Living: {}",
                                                               pop_segement.standard_of_living);
...
<<<<<<< HEAD
                                                    ...
                                                    static float LAN = 0;
                                                    auto& city_coord =
                                                        GetUniverse().get<components::types::SurfaceCoordinate>(
                                                            current_city);
                                                    ...
                                                    if (ImGui::BeginTable(
                                                        ...
                                                        for (entt::entity industry : city_industry.industries) {
                                                            ...
                                                            if (GetUniverse().all_of<components::IndustrySize>(
                                                                ...
                                                                if (diff > 0) {
                                                                    ImGui::TextFmtColored(ImVec4(0, 0.75, 0, 1),
                                                            ...
                                                            if (GetUniverse().all_of<components::Employer>(industry)) {
                                                                ...
                                                                auto& employer =
                                                                    GetUniverse().get<components::Employer>(industry);
                                                                ImGui::TextFmt("{}",
                                                                               NumberToHumanString(static_cast<int64_t>(
