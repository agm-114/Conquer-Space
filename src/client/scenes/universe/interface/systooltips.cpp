...
#include "engine/gui.h"
                ...
                <<<<<<< HEAD < < < < < < <
    HEAD namespace cqsp::client::systems::gui {
...
>>>>>>> pr_254
                ...
                void EntityTooltipContent(const Universe& universe, entt::entity entity) {
                    ...
                    if (universe.all_of<types::Orbit>(entity)) {
                        ...
                        ImGui::TextFmt(
                            "Orbital Period: {} y {} d {} h {} m {} s", (int)(orbit.T() / (60 * 60 * 24 * 365)),
...
<<<<<<< HEAD
                                        void ResourceTooltipSection(const Universe& universe, entt::entity entity) {
                                            == == ==
                                                = void ResourceTooltipSection(const Universe& universe, entity entity) {
>>>>>>> pr_254
...
>>>>>>> pr_254
                                                    ...
                                                    ImGui::TextFmt("Position: {} {} {} ({})", a.position.x,
                                                                   a.position.y, a.position.z, glm::length(a.position));
                                                    ImGui::TextFmt("Velocity: {} {} {} ({})", a.velocity.x,
                                                                   a.velocity.y, a.velocity.z, glm::length(a.velocity));
                                                }
...
<<<<<<< HEAD
                                                    ...
                                                    if (universe.all_of<Body>(entity)) {
                                                        ...
                                                        == == ==
                                                            = ImGui::TextFmt(
                                                                "Population: {}",
                                                                LongToHumanString(common::systems::GetCityPopulation(
                                                                    universe, entity)));
                                                    }
                                                    if (universe.all_of<components::bodies::Body>(entity)) {
...
<<<<<<< HEAD
                                                    if (universe.all_of<Orbit, types::Kinematics>(entity)) {
                                                        ...
                                                        if (universe.valid(ref) && universe.any_of<Body>(ref)) {
                                                            const double radius = universe.get<Body>(ref).radius;
                                                            == == ==
                                                                = if (universe.all_of<types::Orbit, types::Kinematics>(
                                                                          entity)) {
                                                                auto ref =
                                                                    universe.get<types::Orbit>(entity).reference_body;
...
>>>>>>> pr_254
                                                            ...
                                                            if (universe.all_of<types::SurfaceCoordinate>(entity)) {
                                                                ...
                                                                ImGui::TextFmt("Coordinates: {}, {}", pos.latitude(),
                                                                               pos.longitude());
                                                            }
                                                        ...
                                                        void EntityTooltip(const Universe& universe, entity entity) {
