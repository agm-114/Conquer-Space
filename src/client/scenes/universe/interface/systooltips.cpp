...
#include "engine/gui.h"
                ...
                <<<<<<< HEAD < < < < < < <
    HEAD < < < < < < < HEAD namespace cqsp::client::systems::gui {
...
<<<<<<< HEAD
            void RenderEntityType(const Universe& universe, entity entity) {
>>>>>>> pr_254
                ...
                == == == = if (universe.all_of<components::ResourceStockpile>(entity)) {
                    ...
                    // Then do demand
                    DrawLedgerTable("resourcesstockpiletooltip", universe,
                                    universe.get<components::ResourceStockpile>(entity));
                }
                ...
                void EntityTooltipContent(const Universe& universe, entt::entity entity) {
                    ...
                    void ResourceTooltipSection(const Universe& universe, entt::entity entity) {
                        ...
                        if (universe.all_of<components::FailedResourceProduction>(entity)) {
                            ImGui::TextFmtColored(ImVec4(1.0f, 0.4f, 0.4f, 1.0f),
                                                  "Failed resource production last tick");
                        }
                        ...
                        if (universe.all_of<components::IndustrySize>(entity)) {
                            ...
                            ImGui::TextFmt("Utilization: {}",
                                           universe.get<components::IndustrySize>(entity).utilization);
                        }
...
<<<<<<< HEAD
                        ...
                        if (universe.all_of<types::Kinematics>(entity)) {
                            ...
                            ImGui::TextFmt("Position: {} {} {} ({})", a.position.x, a.position.y, a.position.z,
                                           glm::length(a.position));
                            ImGui::TextFmt("Velocity: {} {} {} ({})", a.velocity.x, a.velocity.y, a.velocity.z,
                                           glm::length(a.velocity));
                        }

                        if (universe.all_of<Body>(entity)) {
                            auto& body = universe.get<Body>(entity);
                            ImGui::TextFmt("Day length: {} days (offset {})", body.rotation / 86400,
                        ...
                        if (universe.all_of<components::Settlement>(entity)) {
                            ImGui::TextFmt("Population: {}",
                                           LongToHumanString(common::systems::GetCityPopulation(universe, entity)));
                        }
                        if (universe.all_of<Body>(entity)) {
                            auto& body = universe.get<Body>(entity);
                            ImGui::Separator();
...
>>>>>>> pr-288
                            ...
                            if (universe.all_of<components::IndustrySize>(entity)) {
                                ...
                                ImGui::TextFmt("Utilization: {}",
                                               universe.get<components::IndustrySize>(entity).utilization);
                                ImGui::TextFmt("Last Tick Difference: {}",
                                               universe.get<components::IndustrySize>(entity).diff);
                            }
                            == == == = if (universe.all_of<components::Wallet>(entity)) {
                                auto& balance = universe.get<components::Wallet>(entity);
                                ImGui::TextFmt("Wallet: {}", balance.GetBalance());
...
<<<<<<< HEAD
                                    ...
                                    if (universe.all_of<components::Governed>(entity)) {
                                        auto& governed = universe.get<components::Governed>(entity);
                                        ImGui::TextFmt("Owned by: {}",
                                                       common::util::GetName(universe, governed.governor));
                                    }
                                    ...
                                    if (universe.all_of<components::Settlement>(entity)) {
                                        ImGui::TextFmt(
                                            "Population: {}",
                                            LongToHumanString(common::actions::GetCityPopulation(universe, entity)));
                                    }
                                    if (universe.all_of<Body>(entity)) {
                                        auto& body = universe.get<Body>(entity);
                                        ImGui::Separator();
                                    ...
                                    if (universe.all_of<Orbit, types::Kinematics>(entity)) {
                                        ...
                                        if (universe.valid(ref) && universe.any_of<Body>(ref)) {
                                            const double radius = universe.get<Body>(ref).radius;
                                            double distance =
                                                glm::length(universe.get<types::Kinematics>(entity).position);
                                            ImGui::TextFmt("Altitude: {}", distance - radius);
>>>>>>> pr-292
                                        }
                                    }
                                    ...
                                    void EntityTooltipContent(const Universe& universe, entt::entity entity) {
                                        ...
                                        if (universe.all_of<components::Wallet>(entity)) {
                                            auto& balance = universe.get<components::Wallet>(entity);
                                            ImGui::TextFmt("Wallet: {}",
                                                           util::NumberToHumanString(balance.GetBalance()));
                                        }
                                        ...
                                        if (universe.all_of<components::Settlement>(entity)) {
                                            ...
                                            ImGui::TextFmt(
                                                "Population: {}",
                                                NumberToHumanString(common::actions::GetCityPopulation(node)));
                                        }
                                        if (universe.all_of<Body>(entity)) {
                                            auto& body = universe.get<Body>(entity);
                                            ImGui::Separator();
                                        ...
                                        if (universe.all_of<types::Orbit>(entity)) {
                                            ...
                                            ImGui::TextFmt("Inclination: {} deg", types::toDegree(orbit.inclination));
                                            ImGui::TextFmt("Eccentricity: {}", orbit.eccentricity);
                                            ImGui::TextFmt("Longitude of Linear Node: {} deg",
                                                           types::toDegree(orbit.LAN));
                                            ImGui::TextFmt("Argument of Periapsis: {} deg", types::toDegree(orbit.w));
                                            ImGui::TextFmt("True Anomaly: {} deg", types::toDegree(orbit.v));
                                            ImGui::TextFmt("Orbital Period: {} y {} d {} h {} m {} s",
                                                           (int)(orbit.T() / (60 * 60 * 24 * 365)),
...
<<<<<<< HEAD
                                            void ResourceTooltipSection(const Universe& universe, entt::entity entity) {
                                                == == == = void ResourceTooltipSection(const Universe& universe,
                                                                                       entity entity) {
>>>>>>> pr_254
                                                    if (universe.all_of<components::FailedResourceTransfer>(entity)) {
                                                        ImGui::TextFmtColored(ImVec4(1.0f, 0.4f, 0.4f, 1.0f),
                                                                              "Failed resource transfer last tick");
                                                    }
                                                    if (universe.all_of<components::FailedResourceProduction>(entity)) {
                                                        ImGui::TextFmtColored(ImVec4(1.0f, 0.4f, 0.4f, 1.0f),
                                                                              "Failed resource production last tick");
...
<<<<<<< HEAD
                                                        DrawLedgerTable(
                                                            "resourcesstockpiletooltip", universe,
                                                            universe.get<components::ResourceStockpile>(entity));
                                                        == == ==
...
>>>>>>> pr_254
                                                    ...
                                                    if (universe.all_of<components::IndustrySize>(entity)) {
                                                        ImGui::TextFmt(
                                                            "Size: {}",
                                                            universe.get<components::IndustrySize>(entity).size);
                                                        ImGui::TextFmt(
                                                            "Utilization: {}",
                                                            universe.get<components::IndustrySize>(entity).utilization);
<<<<<<< HEAD
                                                        ImGui::TextFmt(
                                                            "Last Tick Difference: {}",
                                                            universe.get<components::IndustrySize>(entity).diff);
                                                        == == == =
>>>>>>> pr_254
                                                    }

                                                    if (universe.all_of<components::infrastructure::PowerConsumption>(
                                                            entity)) {
                                                        ImGui::Separator();
                                                        auto& consumption =
                                                            universe.get<components::infrastructure::PowerConsumption>(
                                                                entity);
                                                        ImGui::TextFmt("Power: {}", consumption.current);
                                                        ImGui::TextFmt("Max Power: {}", consumption.max);
                                                        ImGui::TextFmt("Min Power: {}", consumption.min);
                                                    ...
                                                    if (universe.all_of<components::CostBreakdown>(entity)) {
                                                        components::CostBreakdown costs =
                                                            universe.get<components::CostBreakdown>(entity);
<<<<<<< HEAD
                                                        ImGui::TextFmt("Material Cost: {}",
                                                                       NumberToHumanString(costs.materialcosts));
                                                        ImGui::TextFmt("Wage Cost: {}",
                                                                       NumberToHumanString(costs.wages));
                                                        ImGui::TextFmt("Maintenance Cost: {}",
                                                                       NumberToHumanString(costs.maintenance));
                                                        ImGui::TextFmt("Transport Costs: {}",
                                                                       NumberToHumanString(costs.transport));
                                                        ImGui::Separator();
                                                        ImGui::TextFmt("Profit: {}", NumberToHumanString(costs.profit));
                                                        ImGui::TextFmt("Revenue: {}",
                                                                       NumberToHumanString(costs.revenue));
                                                    }
                                                    if (universe.all_of<components::Price>(entity)) {
                                                        ImGui::TextFmt("Default Price: {}",
                                                                       universe.get<components::Price>(entity).price);
                                                    }
                                                }

                                                void EntityTooltipContent(const Universe& universe,
                                                                          entt::entity entity) {
                                                    == == == = ImGui::TextFmt("Material Cost: {}",
                                                                              LongToHumanString(costs.materialcosts));
                                                    ImGui::TextFmt("Wage Cost: {}", LongToHumanString(costs.wages));
                                                    ImGui::TextFmt("Maintenance Cost: {}",
                                                                   LongToHumanString(costs.maintenance));
                                                    ImGui::TextFmt("Transport Costs: {}",
                                                                   LongToHumanString(costs.transport));
                                                    ImGui::Separator();
                                                    ImGui::TextFmt("Profit: {}", LongToHumanString(costs.profit));
                                                    ImGui::TextFmt("Revenue: {}", LongToHumanString(costs.revenue));
                                                }
                                            ...
                                            void EntityTooltipContent(const Universe& universe, entity entity) {
>>>>>>> pr_254
                                                if (entity == entt::null) {
                                                    ImGui::TextColored(ImVec4(1.f, 0.f, 0.f, 1.f), "Null entity!");
                                                    return;
...
<<<<<<< HEAD
                                                if (universe.all_of<types::Kinematics>(entity)) {
                                                    == == ==
                                                        = if (universe.all_of<components::types::Kinematics>(entity)) {
>>>>>>> pr_254
                                                        auto& a = universe.get<types::Kinematics>(entity);
                                                        ImGui::TextFmt("Position: {} {} {} ({})", a.position.x,
                                                                       a.position.y, a.position.z,
                                                                       glm::length(a.position));
                                                        ImGui::TextFmt("Velocity: {} {} {} ({})", a.velocity.x,
                                                                       a.velocity.y, a.velocity.z,
                                                                       glm::length(a.velocity));
                                                    }
...
<<<<<<< HEAD
                                                    if (universe.all_of<Body>(entity)) {
                                                        auto& body = universe.get<Body>(entity);
                                                        == == ==
                                                            = if (universe.all_of<components::bodies::Body>(entity)) {
                                                            auto& body = universe.get<bodies::Body>(entity);
>>>>>>> pr_254
                                                            ImGui::TextFmt("Day length: {} days (offset {})",
                                                                           body.rotation / 86400, body.rotation_offset);
                                                        }
...
<<<<<<< HEAD
                                                            ...
                                                            ImGui::TextFmt(
                                                                "Population: {}",
                                                                NumberToHumanString(
                                                                    common::actions::GetCityPopulation(node)));
                                                        }
                                                        if (universe.all_of<Body>(entity)) {
                                                            auto& body = universe.get<Body>(entity);
                                                            == == ==
...
>>>>>>> pr_254
                                                            ImGui::Separator();
                                                            ImGui::TextFmt("Semi Major Axis: {} km",
                                                                           orbit.semi_major_axis);
                                                            ImGui::TextFmt("Inclination: {} deg",
                                                                           types::toDegree(orbit.inclination));
                                                            ImGui::TextFmt("Eccentricity: {}", orbit.eccentricity);
                                                            ImGui::TextFmt("Longitude of Linear Node: {} deg",
                                                                           types::toDegree(orbit.LAN));
                                                            ImGui::TextFmt("Argument of Periapsis: {} deg",
                                                                           types::toDegree(orbit.w));
                                                            ImGui::TextFmt("True Anomaly: {} deg",
                                                                           types::toDegree(orbit.v));
                                                            ImGui::TextFmt(
                                                                "Orbital Period: {} y {} d {} h {} m {} s",
                                                                (int)(orbit.T() / (60 * 60 * 24 * 365)),
                                                                (int)std::fmod(orbit.T() / (60 * 60 * 24), 24),
                                                                (int)std::fmod(orbit.T() / (60 * 60), 60),
                                                                (int)std::fmod(orbit.T() / 60, 60),
...
<<<<<<< HEAD
                                                        if (universe.all_of<Orbit, types::Kinematics>(entity)) {
                                                            ...
                                                            if (universe.valid(ref) && universe.any_of<Body>(ref)) {
                                                                const double radius = universe.get<Body>(ref).radius;
                                                                == == ==
                                                                    = if (universe.all_of<types::Orbit,
                                                                                          types::Kinematics>(entity)) {
                                                                    auto ref = universe.get<types::Orbit>(entity)
                                                                                   .reference_body;
                                                                    if (universe.valid(ref) &&
                                                                        universe.any_of<bodies::Body>(ref)) {
                                                                        const double radius =
                                                                            universe.get<bodies::Body>(ref).radius;
>>>>>>> pr_254
                                                                        double distance = glm::length(
                                                                            universe.get<types::Kinematics>(entity)
                                                                                .position);
                                                                        ImGui::TextFmt("Altitude: {}",
                                                                                       distance - radius);
                                                                    }
                                                                }
                                                                ...
                                                                if (universe.all_of<types::SurfaceCoordinate>(entity)) {
                                                                    auto& pos =
                                                                        universe.get<types::SurfaceCoordinate>(entity);
                                                                    ImGui::TextFmt("Coordinates: {}, {}",
                                                            ...
                                                            void EntityTooltip(const Universe& universe,
                                                                               entity entity) {
