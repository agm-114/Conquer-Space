...
<<<<<<< HEAD
                                        ...
                                        if (ImGui::IsItemHovered()) {
                                            ...
                                            GetUniverse().get_or_emplace<CommandQueue>(body).commands.push_back(
                                                maneuver);
                                        }
                                        if (ImGui::IsItemHovered()) {
                                            double circular_velocity =
                                            ...
                                            // Get the vector of the direction and then compute?
                                            // Then transform by the orbital math
                                            double orbit_velocity = OrbitVelocity(types::PI, orbit.eccentricity,
                                                                                  orbit.semi_major_axis, orbit.GM);
...
<<<<<<< HEAD
                                            ...
                                            ImGui::SetTooltip("Delta-v: %f km/s", new_v - periapsis_velocity);
                                            == == == = double new_v = types::OrbitVelocityAtR(orbit.GM, new_sma,
                                                                                              orbit.GetApoapsis());
...
<<<<<<< HEAD
                                        ...
                                        == == == = auto& o_system =
                                                     GetUniverse().get<components::bodies::OrbitalSystem>(
...
<<<<<<< HEAD
                                        ...
                                        double ttma =
                                            orbit.TimeToMeanAnomaly(types::AscendingTrueAnomaly(orbit, target));
>>>>>>> pr_254
                                        ImGui::TextFmt("Time to ascending node: {}", ttma);
                                        if (ImGui::BeginChild("Rendezvous Target")) {
                                            for (auto& entity : o_system.children) {
