                    ...
                    void SpaceshipWindow::DoUI(int delta_time) {
                        ...
                        if (ImGui::CollapsingHeader("Basic Orbital Maneuvers")) {
                            ...
                            if (ImGui::Button("Circularize at apoapsis")) {
                                ...
                                common::systems::commands::PushManeuvers(
                                    GetUniverse(), body, {common::systems::CircularizeAtApoapsis(orbit)});
                            }
                            if (ImGui::IsItemHovered()) {
                            ...
                            if (ImGui::IsItemHovered()) {
                                ...
                                // Get velocity at the new apogee
                                double new_v = common::components::types::OrbitVelocityAtR(orbit.GM, new_sma,
                                                                                           orbit.GetPeriapsis());
                                ImGui::SetTooltip("Delta-v: %f km/s", new_v - periapsis_velocity);
                            }
                        ...
                        if (ImGui::CollapsingHeader("Rendezvous")) {
                            ...
                            if (ImGui::Button("Rendez-vous!")) {
                                // Rdv with target
                                auto pair = cqsp::common::systems::CoplanarIntercept(orbit, target,
...
<<<<<<< HEAD
                                                            ...
                                                            if (ImGui::IsItemHovered()) {
                                                                ...
                                                                double orbit_velocity =
                                                                    OrbitVelocity(types::PI, orbit.eccentricity,
                                                                                  orbit.semi_major_axis, orbit.GM);
                                                                ImGui::SetTooltip("Delta-v: %f km/s",
...
<<<<<<< HEAD
                                                                ...
                                                                maneuver.time =
                                                                    GetUniverse().date.ToSecond() + m.second;
                                                                GetUniverse()
                                                                    .get_or_emplace<CommandQueue>(body)
                                                                    .commands.push_back(maneuver);
>>>>>>> pr_254
                                                            ...
                                                            if (ImGui::IsItemHovered()) {
                                                                double new_sma =
                                                                    (orbit.GetApoapsis() + new_perigee) / 2;
                                                                // Get velocity at the new apogee
<<<<<<< HEAD
                                                                double new_v =
                                                                    common::components::types::OrbitVelocityAtR(
                                                                        orbit.GM, new_sma, orbit.GetApoapsis());
                                                                ImGui::SetTooltip("Delta-v: %f km/s",
                                                                                  new_v - periapsis_velocity);
                                                                == == == = double new_v = types::OrbitVelocityAtR(
                                                                             orbit.GM, new_sma, orbit.GetApoapsis());
                                                                double orbit_velocity = types::OrbitVelocity(
                                                                    0, orbit.eccentricity, orbit.semi_major_axis,
                                                                    orbit.GM);
                                                                ImGui::SetTooltip("Delta-v: %f km/s",
...
>>>>>>> pr_254
                                                            ...
                                                            if (ImGui::IsItemHovered()) {
                                                                double new_sma =
                                                                    (orbit.GetPeriapsis() + new_apogee) / 2;
                                                                // Get velocity at the new apogee
<<<<<<< HEAD
                                                                double new_v =
                                                                    common::components::types::OrbitVelocityAtR(
...
>>>>>>> pr_254
                                                            ...
                                                            if (ImGui::Button("Set New Orbit")) {
                                                                // Get velocity at the new apogee
                                                                // Get the velocity
                                                                auto hohmann = common::systems::HohmannTransfer(
                                                                    orbit, new_hohmann);
                                                                if (hohmann.has_value()) {
<<<<<<< HEAD
                                                                    PushManeuvers(GetUniverse(), body, *hohmann);
                                                                    == == ==
                                                                        = auto& queue =
                                                                            GetUniverse().get_or_emplace<CommandQueue>(
                                                                                body);
                                                                    Maneuver man_1(hohmann->first);
                                                                    Maneuver man_2(hohmann->second);
                                                                    man_1.time +=
                                                                        (GetUniverse().date.ToSecond() + 1000);
                                                                    man_2.time +=
                                                                        (GetUniverse().date.ToSecond() + 1000);
...
<<<<<<< HEAD
                                                            ...
                                                            static entt::entity selected =
                                                                o_system.children.empty() ? entt::null
                                                            ...
                                                            == == == = auto& o_system =
                                                                         GetUniverse()
                                                                             .get<components::bodies::OrbitalSystem>(
                                                                                 orbit.reference_body);
                                                            static entity selected = o_system.children.empty()
                                                                                         ? entt::null
                                                                                         : o_system.children.front();
                                                            auto& target = GetUniverse().get<Orbit>(selected);
...
<<<<<<< HEAD
                                                            ...
                                                            if (ImGui::Button("Maneuver to point")) {
                                                                auto pair = cqsp::common::systems::CoplanarIntercept(
                                                                    orbit, target, GetUniverse().date.ToSecond());
                                                                auto& queue =
                                                                    GetUniverse().get_or_emplace<CommandQueue>(body);
...
>>>>>>> pr_254
                                                                ...
                                                                common::systems::commands::PushManeuver(GetUniverse(),
                                                                                                        body, maneuver);
                                                            }
<<<<<<< HEAD
                                                            ImGui::TextFmt(
                                                            ...
                                                            ImGui::TextFmt(
                                                                ...
                                                                cqsp::common::components::types::CalculateTransferAngle(
                                                                    orbit, target));
                                                            double ttma = orbit.TimeToTrueAnomaly(
                                                                common::components::types::AscendingTrueAnomaly(
                                                                    orbit, target));
                                                            if (ImGui::Button("Lambert transfer")) {
                                                                // Compute lambert problem
                                                                // Get future position of the entity
                                                            ...
                                                            ImGui::TextFmt(
                                                                "Transfer angle: {}",
                                                                types::CalculateTransferAngle(orbit, target));
                                                            double ttma = orbit.TimeToMeanAnomaly(
                                                                types::AscendingTrueAnomaly(orbit, target));
>>>>>>> pr_254
                                                            ImGui::TextFmt("Time to ascending node: {}", ttma);
                                                            if (ImGui::BeginChild("Rendezvous Target")) {
                                                                for (auto& entity : o_system.children) {
                                                        ...
                                                        if (ImGui::CollapsingHeader("Moon Transfers")) {
                                                            ...
                                                            double angle = common::components::types::AngleWith(
                                                                orbit,
                                                                GetUniverse().get<types::Orbit>(orbit.reference_body));
                                                            ...
                                                            if (ImGui::Button("Transfer to Moon")) {
                                                                common::systems::commands::TransferToMoon(
                                                                    GetUniverse(), body, selected);
                                                            }
                                                            ...
                                                            if (ImGui::Button("Land On City")) {
                                                                ...
                                                                // Just grab the first one
                                                                auto& cities =
                                                                    GetUniverse().get<components::Habitation>(selected);
                                                                if (!cities.settlements.empty()) {
                                                                    common::systems::commands::LandOnMoon(
                                                                        GetUniverse(), body, selected,
                                                                        cities.settlements.front());
                                                                }
                                                            }
