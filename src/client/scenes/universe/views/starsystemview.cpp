...
>>>>>>> pr-288
                    ...
                    // Check for resized window
                    window_ratio =
                        static_cast<float>(m_app.GetWindowWidth()) / static_cast<float>(m_app.GetWindowHeight());
...
>>>>>>> pr_254
                                    ...
                                    void SysStarSystemRenderer::DrawTexturedPlanet(const glm::vec3& object_pos,
                                        ...
                                        position *=
                                            glm::mat4(GetBodyRotation(body.axial, body.rotation, body.rotation_offset));
                                    ...
                                    void SysStarSystemRenderer::GetPlanetTexture(
                                        const entt::entity entity, bool& have_normal, bool& have_roughness,
                                        bool& have_province) {
...
<<<<<<< HEAD
                                                ...
                                                == == == = void SysStarSystemRenderer::DrawStar(
                                                ...
                                                void SysStarSystemRenderer::RenderCities(
                                                    glm::vec3 & object_pos, const entt::entity& body_entity) {
                                                    ZoneScoped;
                                                    // Draw Cities
...
<<<<<<< HEAD
                                                            == == == = auto ships =
                                                                         m_universe.view<Ship, ctx::VisibleOrbit>();
>>>>>>> pr_254

                                                            renderer.BeginDraw(ship_icon_layer);
                                                            ship_overlay.shaderProgram->UseProgram();
                                                            for (entt::entity ship :
                                                                 m_universe.view<ships::Ship, ctx::VisibleOrbit>()) {
                                                                // if it's not visible, then don't render
<<<<<<< HEAD
                                                                glm::vec3 object_pos = CalculateCenteredObject(ship);
                                                                ship_overlay.shaderProgram->setVec4("color", 1, 0, 0,
                                                                                                    1);
                                                                // Interpolate so that it looks nice
                                                                if (m_universe.any_of<types::FuturePosition>(ship)) {
                                                                    auto& future_comp =
                                                                        m_universe.get<types::FuturePosition>(ship);
                                                                    == == == = vec3 object_pos =
                                                                                 CalculateCenteredObject(ent_id);
                                                                    ship_overlay.shaderProgram->setVec4("color", 1, 0,
                                                                                                        0, 1);
                                                                    // Interpolate so that it looks nice
                                                                    if (m_universe.any_of<types::FuturePosition>(
                                                                            ent_id)) {
                                                                        auto& future_comp =
                                                                            m_universe.get<types::FuturePosition>(
                                                                                ent_id);
>>>>>>> pr_254
                                                                        const auto& pos =
                                                                            future_comp.position + future_comp.center;
                                                                        vec3 future_pos =
                                                                            CalculateCenteredObject(ConvertPoint(pos));
                                                                        DrawShipIcon(
                                                                            glm::mix(object_pos, future_pos,
                                                                                     m_universe.tick_fraction));
                                                                    } else {
...
<<<<<<< HEAD
                                                                ...
                                                                for (entt::entity ship :
                                                                     m_universe
                                                                         .view<ships::Ship, ctx::VisibleOrbit>()) {
                                                                    // Get the model of the object
                                                                    entt::entity body_entity = ship;

<<<<<<< HEAD
                                                                    if (!m_universe.any_of<components::WorldModel>(
                                                                            body_entity)) {
                                                                        continue;
                                                                    }
                                                                    auto model_name =
                                                                        m_universe.get<components::WorldModel>(
                                                                            body_entity);
                                                                    glm::vec3 object_pos =
                                                                        CalculateCenteredObject(body_entity);
                                                                    if (glm::distance(cam_pos, object_pos) > 1000) {
                                                                        continue;
                                                                    }
                                                                    auto model =
                                                                        m_app.GetAssetManager().GetAsset<asset::Model>(
                                                                            model_name.name);
                                                                    glm::mat4 transform = glm::mat4(1.f);
                                                                    ...
                                                                    model->shader->SetMVP(transform, camera_matrix,
                                                                                          projection);
                                                                    model->Draw();
                                                                    == == ==
                                                                        = void
                                                                        SysStarSystemRenderer::LoadPlanetTextures() {
                                                                        for (auto body : m_universe.view<Orbit>()) {
                                                                            if (!m_universe
                                                                                     .all_of<bodies::TexturedTerrain>(
                                                                                         body)) {
                                                                                continue;
                                                                            }
                                                                            auto textures =
                                                                                m_universe.get<bodies::TexturedTerrain>(
                                                                                    body);
                                                                            auto& data =
                                                                                m_universe
                                                                                    .get_or_emplace<PlanetTexture>(
                                                                                        body);
                                                                            data.terrain =
                                                                                m_app.GetAssetManager()
                                                                                    .GetAsset<Texture>(
                                                                                        textures.terrain_name);
                                                                            if (!textures.normal_name.empty()) {
                                                                                data.normal =
                                                                                    m_app.GetAssetManager()
                                                                                        .GetAsset<Texture>(
                                                                                            textures.normal_name);
                                                                            }
                                                                            if (!textures.roughness_name.empty()) {
                                                                                data.roughness =
                                                                                    m_app.GetAssetManager()
                                                                                        .GetAsset<Texture>(
                                                                                            textures.roughness_name);
                                                                            }
                                                                            if (!m_universe.any_of<
                                                                                    components::ProvincedPlanet>(
                                                                                    body)) {
                                                                                continue;
                                                                            }
                                                                            auto& province_map =
                                                                                m_universe
                                                                                    .get<components::ProvincedPlanet>(
                                                                                        body);
                                                                            // Add province data if they have it
                                                                            data.province_texture =
                                                                                m_app.GetAssetManager()
                                                                                    .GetAsset<Texture>(
                                                                                        province_map.province_texture);

                                                                            asset::BinaryAsset* bin_asset =
                                                                                m_app.GetAssetManager()
                                                                                    .GetAsset<asset::BinaryAsset>(
                                                                                        province_map.province_map);
                                                                            if (bin_asset == nullptr) {
                                                                                SPDLOG_ERROR(
                                                                                    "Could not find the planet "
                                                                                    "province map {}",
                                                                                    province_map.province_map);
                                                                                continue;
                                                                            }
                                                                                ...
                                                                                for (int y = 0; y < province_height;
                                                                                    ...
                                                                                    std::tuple<int, int, int, int> t =
                                                                                        std::make_tuple(
                                                                                            d[pos], d[pos + 1],
                                                                                            d[pos + 2], d[pos + 3]);
                                                                                    int i = components::ProvinceColor::
                                                                                        toInt(std::get<0>(t),
                                                                                              std::get<1>(t),
                                                                                              std::get<2>(t));
                                                                                    if (m_universe.province_colors[body]
                                                                                            .find(i) !=
                                                                                        m_universe.province_colors[body]
                                                                                            .end()) {
                                                                                        data.province_map.push_back(
                                                                                            m_universe
                                                                                                .province_colors[body]
                                                                                                                [i]);
                                                                                    } else {
                                                                                        data.province_map.push_back(
                                                                                            entt::null);
>>>>>>> pr-288
                                                                                ...
                                                                                SysStarSystemRenderer::DrawEntityName(
                                                                                    ...
                                                                                    entt::entity ent_id) {
                                                                                    std::string text =
                                                                                        GetName(m_universe, ent_id);
                                                                                    glm::vec3 pos =
                                                                                        GetBillboardPosition(
                                                                                            object_pos);
                                                                                    == == ==
                                                                                        = auto ships = m_universe.view<
                                                                                            Ship, ctx::VisibleOrbit>();
                                                                                    // Loop through the space bodies that are close
                                                                                    for (entity body_entity : ships) {
                                                                                        vec3 object_pos =
                                                                                            CalculateCenteredObject(
                                                                                                body_entity);
                                                                                        if (glm::distance(cam_pos,
                                                                                                          object_pos) >
                                                                                            1000) {
                                                                                            continue;
                                                                                        }
                                                                                ...
                                                                                void
                                                                                SysStarSystemRenderer::DrawEntityName(
                                                                                    vec3 & object_pos, entity ent_id) {
                                                                                    std::string text =
                                                                                        GetName(m_universe, ent_id);
                                                                                    vec3 pos = GetBillboardPosition(
                                                                                        object_pos);
>>>>>>> pr_254
                                                                                    // Check if the position on screen is within bounds
                                                                                    if (pos.z < 1 && pos.z > -1 &&
                                                                                        ...
                                                                                        m_app.DrawText(text, pos.x,
                                                                                                       pos.y, 20);
                                                                                    }
                                                                                }

                                                                                void
                                                                                SysStarSystemRenderer::DrawPlanetIcon(
                                                                                    vec3 & object_pos) {
                                                                                    mat4 planetDispMat =
                                                                                        GetBillboardMatrix(
                                                                                            GetBillboardPosition(
...
<<<<<<< HEAD
                                                                                    ...
                                                                                    void
                                                                                    SysStarSystemRenderer::DrawCityIcon(
...
>>>>>>> pr-288
                                                                                ...
                                                                                void
                                                                                SysStarSystemRenderer::DrawAllCities(
                                                                                    auto& bodies) {
                                                                                    for (auto body_entity : bodies) {
<<<<<<< HEAD
                                                                                        glm::vec3 object_pos =
                                                                                        ...
                                                                                        // if (glm::distance(object_pos, cam_pos) <= dist) {
>>>>>>> pr_254
                                                                                        RenderCities(object_pos,
                                                                                                     body_entity);
                                                                                    }
                                                                                }

                                                                                void
                                                                                SysStarSystemRenderer::DrawShipIcon(
                                                                                    const vec3& object_pos) {
                                                                                    vec3 pos = GetBillboardPosition(
                                                                                        object_pos);
                                                                                    mat4 shipDispMat =
                                                                                    ...
                                                                                    float window_ratio =
                                                                                        GetWindowRatio();
                                                                                    vec4 gl_Position =
                                                                                        CalculateGLPosition(object_pos);
                                                                                    ...
                                                                                    shipDispMat = glm::scale(
                                                                                        shipDispMat,
                                                                                        vec3(1, window_ratio, 1));
                                                                                    SetBillboardProjection(
                                                                                        ship_overlay.shaderProgram,
                                                                                        shipDispMat);
                                                                                    engine::Draw(ship_overlay);
                                                                                }
                                                                                ...
                                                                                void SysStarSystemRenderer::
                                                                                    ...
                                                                                    GetPlanetTexture(
                                                                                        entity, have_normal,
                                                                                        have_roughness, have_province);

<<<<<<< HEAD
                                                                                    this->have_province = have_province;

                                                                                    auto& body =
                                                                                        m_universe.get<bodies::Body>(
                                                                                            entity);
                                                                                    glm::mat4 position = glm::mat4(1.f);
                                                                                    == == == = auto& body =
                                                                                                 m_universe.get<Body>(
...
>>>>>>> pr_254
                                                                                    position = glm::translate(
                                                                                        position, object_pos);
                                                                                    position *= mat4(GetBodyRotation(
                                                                                        body.axial, body.rotation,
                                                                                        body.rotation_offset));
                                                                                    ...
                                                                                    float scale =
                                                                                        body.radius;  // types::toAU(body.radius)
                                                                                                      // * view_scale;
                                                                                    position = glm::scale(position,
                                                                                                          vec3(scale));

                                                                                    auto shader =
                                                                                        textured_planet.shaderProgram
                                                                                            .get();
                                                                                    if (scale < 10.f) {
                                                                                        // then use different shader if it's close enough
                                                                                        shader = near_shader.get();
                                                                                    ...
                                                                                    shader->SetMVP(position,
                                                                                                   camera_matrix,
                                                                                                   projection);

                                                                                    // Maybe a seperate shader for planets without normal maps would be better
                                                                                    shader->setBool("haveNormal",
                                                                                                    have_normal);

                                                                                    shader->setVec3(
                                                                                        "lightDir",
                                                                                        glm::normalize(sun_position -
                                                                                                       object_pos));
                                                                                    shader->setVec3("lightPosition",
                                                                                                    sun_position);
...
<<<<<<< HEAD
                                                                                    ...
                                                                                    == == ==
                                                                                        = shader->setVec4(
                                                                                            "country_color",
                                                                                            vec4(selected_country_color,
                                                                                                 1));
>>>>>>> pr_254
                                                                                    shader->setBool("country",
                                                                                                    have_province);
                                                                                    shader->setBool("is_roughness",
                                                                                                    have_roughness);
                                                                                ...
                                                                                SysStarSystemRenderer::GetPlanetTexture(
                                                                                    ...
                                                                                    bool& have_province) {
                                                                                    if (!m_universe
                                                                                             .all_of<PlanetTexture>(
                                                                                                 entity)) {
                                                                                        return;
                                                                                    }
                                                                                    auto& terrain_data =
                                                                                        m_universe.get<PlanetTexture>(
                                                                                            entity);
                                                                                    textured_planet.textures.clear();
                                                                                    textured_planet.textures.push_back(
                                                                                        terrain_data.terrain);
                                                                                    if (terrain_data.normal !=
                                                                                        nullptr) {
                                                                                        have_normal = true;
                                                                                        textured_planet.textures
                                                                                            .push_back(
                                                                                                terrain_data.normal);
                                                                                    } else {
                                                                                        textured_planet.textures
                                                                                    ...
                                                                                    have_province =
                                                                                        (terrain_data
                                                                                             .province_texture !=
                                                                                         nullptr);
                                                                                    if (terrain_data.province_texture !=
                                                                                        nullptr) {
                                                                                        textured_planet.textures
                                                                                            .push_back(
                                                                                                terrain_data
                                                                                ...
                                                                                void
                                                                                SysStarSystemRenderer::DrawAllPlanets(
                                                                                    auto& bodies) {
                                                                                    ZoneScoped;
<<<<<<< HEAD
                                                                                    for (entt::entity body_entity :
                                                                                         bodies) {
                                                                                        glm::vec3 object_pos =
                                                                                            CalculateCenteredObject(
                                                                                                body_entity);
...
>>>>>>> pr-288
    ...
    return glm::quat {{0, 0, (float)-axial}} * glm::quat {{0, (float)std::fmod(rot, types::TWOPI), 0}};
                                                                                                ...
                                                                                                SysStarSystemRenderer::
                                                                                                    FocusCityView() {
                                                                                                    ZoneScoped;
                                                                                                    auto focused_city_view =
                                                                                                        m_universe.view<
                                                                                                            FocusedCity>();
                                                                                                    // City to focus view on
                                                                                                    if (focused_city_view
                                                                                                            .empty()) {
                                                                                                        return;
                                                                                                    }
                                                                                                    selected_city =
...
>>>>>>> pr_254
                                                                                                        ...
                                                                                                        SysStarSystemRenderer::
                                                                                                            CalculateCenteredObject(
                                                                                                                const entity&
                                                                                                                    ent) {
                                                                                                            return CalculateCenteredObject(
                                                                                                                CalculateObjectPos(
                                                                                                                    ent));
                                                                                                        }
...
>>>>>>> pr_254
                                                                                                                ...
                                                                                                                // Make the UI
                                                                                                                unsigned int
                                                                                                                    a = GeneratePlanetTexture(
                                                                                                                        gen.GetHeightMap());
                                                                                                                planet_resource = GenerateTexture(
                                                                                                                    a,
                                                                                                                    gen.GetHeightMap());
                                                                                                                terrain_displaying =
                                                                                                                    rend.resource;
...
<<<<<<< HEAD
<<<<<<< HEAD
                                                                                                                        entt::entity settlement = common::
                                                                                                                            systems::actions::CreateCity(
                                                                                                                                m_universe,
                                                                                                                                on_planet,
                                                                                                                                s.latitude(),
                                                                                                                                s.longitude());
...
<<<<<<< HEAD
                                                                                                                                ...
                                                                                                                                if (have_province) {
                                                                                                                                    ImGui::TextFmt(
                                                                                                                                        "Current planet has province");
                                                                                                                                } else {
                                                                                                                                    ImGui::TextFmt(
                                                                                                                                        "Current planet has no province");
                                                                                                                                }
                                                                                                                                entt::entity earth =
                                                                                                                                    m_universe
                                                                                                                                        .planets
                                                                                                                                                    ...
                                                                                                                                                    int color =
                                                                                                                                                        m_universe
                                                                                                                                                            .colors_province
                                                                                                                                                                ...
                                                                                                                                                                [hovering_province];
                                                                                                                                                    auto province_color =
                                                                                                                                                        components::ProvinceColor::
                                                                                                                                                            fromInt(
                                                                                                                                                                color);
                                                                                                                                                    hovering_province_color =
                                                                                                                                                        (glm::vec3(
                                                                                                                                                             (float)province_color
                                                                                                                                                                 .r,
                                                                                                                                                             (float)province_color
                                                                                                                                                                 .g,
                                                                                                                                                             (float)province_color
...
<<<<<<< HEAD
                                                                                                                                                        ...
                                                                                                                                                        == ==
                                                                                                                                                            ==
                                                                                                                                                            = vec3 ray_wor = CalculateMouseRay(
                                                                                                                                                                vec3(
                                                                                                                                                                    x,
                                                                                                                                                                    y,
                                                                                                                                                                    z));
