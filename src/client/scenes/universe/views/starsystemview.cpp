...
>>>>>>> pr_254
                                    ...
                                    int province_width;
                                    int province_height;
                                    auto d = stbi_load_from_memory(bin_asset->data.data(), file_size, &province_width,
                                                                   &province_height, &comp, 0);
                            ...
                            void SysStarSystemRenderer::InitializeFramebuffers() {
                                ...
                                ship_icon_layer =
                                    renderer.AddLayer<engine::FramebufferRenderer>(buffer_shader, *m_app.GetWindow());
                                physical_layer =
                                    renderer.AddLayer<engine::FramebufferRenderer>(buffer_shader, *m_app.GetWindow());
                                planet_icon_layer =
                                    renderer.AddLayer<engine::FramebufferRenderer>(buffer_shader, *m_app.GetWindow());
...
<<<<<<< HEAD
                                ...
                                == == == = engine::Mesh_t sphere_mesh = cqsp::engine::primitive::ConstructSphereMesh(
...
<<<<<<< HEAD
                                == == == =
                                             // Initialize shaders
                                    ShaderProgram_t planet_shader = m_app.GetAssetManager()
...
<<<<<<< HEAD
                                ...
                                orbit_shader = m_app.GetAssetManager()
                                                   ...
                                                   ->MakeShader();
                                vis_shader =
                                    m_app.GetAssetManager().GetAsset<ShaderDefinition>("core:vertex_vis")->MakeShader();
...
>>>>>>> pr_254
                                ...
                                bool SysStarSystemRenderer::GLPositionNotInBounds(const vec4& gl_Position,
                                                                                  const vec3& pos) {
                                    return (isnan(gl_Position.z)) || pos.x <= 0 || pos.x >= m_app.GetWindowWidth() ||
...
>>>>>>> pr_254
                                    ...
                                    void SysStarSystemRenderer::CalculateCamera() {
                                        cam_pos =
                                            vec3(cos(view_y) * sin(view_x), sin(view_y), cos(view_y) * cos(view_x)) *
                                            (float)scroll;
