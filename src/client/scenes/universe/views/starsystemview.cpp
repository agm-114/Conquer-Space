...
>>>>>>> pr_254
        ...
        void SysStarSystemRenderer::Update(float deltaTime) {
            ...
            if (!ImGui::GetIO().WantCaptureMouse && !m_app.GetRmlUiContext()->IsMouseInteracting()) {
                ...
                if (m_app.MouseButtonIsReleased(engine::MouseInput::LEFT) && ent != entt::null &&
                    !m_app.MouseDragged()) {
                    FocusOnEntity(ent);
...
>>>>>>> pr_254
                ...
                void SysStarSystemRenderer::GetPlanetTexture(const entity entity, bool& have_normal,
                                                             bool& have_roughness, bool& have_province) {
...
<<<<<<< HEAD
                        void SysStarSystemRenderer::DrawTerrainlessPlanet(const entt::entity& entity,
                                                                          glm::vec3& object_pos) {
                            glm::mat4 position = glm::mat4(1.f);
                            == == == = void SysStarSystemRenderer::DrawTerrainlessPlanet(const entity& entity,
                                                                                         vec3& object_pos) {
                                mat4 position = mat4(1.f);
>>>>>>> pr_254
                                position = glm::translate(position, object_pos);
...
<<<<<<< HEAD
                                ...
                                == == == = std::vector<entity> cities =
                                             m_universe.get<Habitation>(body_entity).settlements;
>>>>>>> pr_254
                                if (cities.empty()) {
                                    return;
                                }
...
<<<<<<< HEAD
                                std::vector<entt::entity> cities =
                                    m_universe.get<Habitation>(m_viewing_entity).settlements;
                                == == == = std::vector<entity> cities =
                                             m_universe.get<Habitation>(m_viewing_entity).settlements;
>>>>>>> pr_254
                                if (cities.empty()) {
                                ...
                                for (auto& city_entity : cities) {
                                    ...
                                    m_universe.emplace_or_replace<Offset>(city_entity,
                                                                          types::toVec3(coord.universe_view(), 1));
                                }
...
<<<<<<< HEAD
                                        ...
                                        == == == = if (!m_universe.all_of<TexturedTerrain>(body)) { continue; }
...
>>>>>>> pr_254
                                        ...
                                        if (!textures.normal_name.empty()) {
                                            data.normal =
                                                m_app.GetAssetManager().GetAsset<Texture>(textures.normal_name);
                                        }
                                        if (!textures.roughness_name.empty()) {
                                            data.roughness =
                                                m_app.GetAssetManager().GetAsset<Texture>(textures.roughness_name);
                                        }
                                        ...
                                        data.province_texture =
                                            m_app.GetAssetManager().GetAsset<Texture>(province_map.province_texture);

<<<<<<< HEAD
                                        asset::BinaryAsset* bin_asset =
                                            m_app.GetAssetManager().GetAsset<asset::BinaryAsset>(
                                                province_map.province_map);
                                        if (bin_asset == nullptr) {
                                            SPDLOG_ERROR("Could not find the planet province map {}",
                                                         province_map.province_map);
                                            continue;
                                        }
                                        == == == = asset::BinaryAsset* bin_asset =
                                                     m_app.GetAssetManager().GetAsset<cqsp::asset::BinaryAsset>(
                                                         province_map.province_map);
>>>>>>> pr_254
                                        // Then create vector
                                        ...
                                        int province_width;
                                        int province_height;
                                        auto d = stbi_load_from_memory(bin_asset->data.data(), file_size,
                                                                       &province_width, &province_height, &comp, 0);
                                        ...
                                        for (int x = 0; x < province_width; x++) {
                                            for (int y = 0; y < province_height; y++) {
                                                ...
                                                std::tuple<int, int, int, int> t =
                                                    std::make_tuple(d[pos], d[pos + 1], d[pos + 2], d[pos + 3]);
                                                int i = components::ProvinceColor::toInt(std::get<0>(t), std::get<1>(t),
                                                                                         std::get<2>(t));
                                                if (m_universe.province_colors[body].find(i) !=
                                                    m_universe.province_colors[body].end()) {
                                ...
                                void SysStarSystemRenderer::InitializeFramebuffers() {
                                    ...
                                    ship_icon_layer = renderer.AddLayer<engine::FramebufferRenderer>(
                                        buffer_shader, *m_app.GetWindow());
                                    physical_layer = renderer.AddLayer<engine::FramebufferRenderer>(buffer_shader,
                                                                                                    *m_app.GetWindow());
                                    planet_icon_layer = renderer.AddLayer<engine::FramebufferRenderer>(
                                        buffer_shader, *m_app.GetWindow());
                                    skybox_layer = renderer.AddLayer<engine::FramebufferRenderer>(buffer_shader,
                                                                                                  *m_app.GetWindow());
                                }
...
<<<<<<< HEAD
                                    engine::Mesh_t sphere_mesh =
                                        engine::primitive::ConstructSphereMesh(sphere_resolution, sphere_resolution);
                                    ...
                                    == == == = engine::Mesh_t sphere_mesh =
                                                 cqsp::engine::primitive::ConstructSphereMesh(sphere_resolution,
                                                                                              sphere_resolution);
                                    ...
                                    sky.mesh = engine::primitive::MakeCube();
                                    sky.shaderProgram =
                                        m_app.GetAssetManager().GetAsset<ShaderDefinition>("core:skybox")->MakeShader();

                                    asset::ShaderProgram_t circle_shader =
                                        m_app.GetAssetManager()
                                            .GetAsset<ShaderDefinition>("core:2dcolorshader")
                                            ->MakeShader();
>>>>>>> pr_254
...
<<<<<<< HEAD
                                    == == == =
                                        ...
                                        ShaderProgram_t planet_shader =
                                            m_app.GetAssetManager()
                                                .GetAsset<ShaderDefinition>("core:planetshader")
                                                ->MakeShader();
...
<<<<<<< HEAD
                                    == == == =
                                        ...
                                        ShaderProgram_t textured_planet_shader =
                                            m_app.GetAssetManager()
                                                .GetAsset<ShaderDefinition>("core:planet_textureshader")
                                                ->MakeShader();
                                    near_shader = m_app.GetAssetManager()
                                                      .GetAsset<ShaderDefinition>("core:neartexturedobject")
                                                      ->MakeShader();
>>>>>>> pr_254
...
<<<<<<< HEAD
                                    ...
                                    == == == = sun.shaderProgram = m_app.GetAssetManager()
                                                                       .GetAsset<ShaderDefinition>("core:sunshader")
                                                                       ->MakeShader();

                                    orbit_shader = m_app.GetAssetManager()
                                                       .GetAsset<ShaderDefinition>("core:orbitshader")
                                                       ->MakeShader();
                                    vis_shader = m_app.GetAssetManager()
                                                     .GetAsset<ShaderDefinition>("core:vertex_vis")
                                                     ->MakeShader();
                                    iss_model = m_app.GetAssetManager().GetAsset<asset::Model>("core:iss");
                                    model_shader = m_app.GetAssetManager()
                                                       .GetAsset<ShaderDefinition>("core:model_log_shader")
                                                       ->MakeShader();
>>>>>>> pr_254
                                }
...
>>>>>>> pr_254
                                    ...
                                    vec3 SysStarSystemRenderer::CalculateCenteredObject(const vec3& vec) {
                                        return vec - view_center;
                                    }

                                    vec3 SysStarSystemRenderer::TranslateToNormalized(const vec3& pos) {
                                        return vec3((pos.x / m_app.GetWindowWidth() - 0.5) * 2,
                                                    (pos.y / m_app.GetWindowHeight() - 0.5) * 2, 0);
                                    }

                                    vec3 SysStarSystemRenderer::ConvertPoint(const vec3& pos) {
                                    ...
                                    bool SysStarSystemRenderer::GLPositionNotInBounds(const vec4& gl_Position,
                                                                                      const vec3& pos) {
                                        return (isnan(gl_Position.z)) || pos.x <= 0 ||
                                               pos.x >= m_app.GetWindowWidth() || pos.y <= 0 ||
                                    ...
                                    mat4 SysStarSystemRenderer::GetBillboardMatrix(const vec3& pos) {
                                        ...
                                        billboardDispMat =
                                            glm::scale(billboardDispMat, vec3(circle_size, circle_size, circle_size));
...
<<<<<<< HEAD
                                    void SysStarSystemRenderer::SetBillboardProjection(ShaderProgram_t & shader,
                                                                                       glm::mat4 mat) {
                                        == == == = void SysStarSystemRenderer::SetBillboardProjection(
                                                     cqsp::asset::ShaderProgram_t & shader, mat4 mat) {
>>>>>>> pr_254
                                            shader->UseProgram();
...
<<<<<<< HEAD
                                            ...
                                            == == == = if (!m_universe.any_of<Body>(planet)) { return; }
                                            auto& body = m_universe.get<Body>(planet);
...
>>>>>>> pr_254
                                        ...
                                        void SysStarSystemRenderer::CalculateCamera() {
                                            cam_pos = vec3(cos(view_y) * sin(view_x), sin(view_y),
                                                           cos(view_y) * cos(view_x)) *
                                                      (float)scroll;
                                            cam_up = vec3(0.0f, 1.0f, 0.0f);
                                            camera_matrix = glm::lookAt(cam_pos, vec3(0.f, 0.f, 0.f), cam_up);
                                            projection =
                                                glm::infinitePerspective(glm::radians(45.f), GetWindowRatio(), 0.1f);
...
<<<<<<< HEAD
                                            if (!m_universe.any_of<components::ResourceDistribution>(
                                                    m_viewing_entity)) {
...
>>>>>>> pr_254
                                                ...
                                                auto& dist =
                                                    m_universe.get<components::ResourceDistribution>(m_viewing_entity);
                                            ...
                                            void SysStarSystemRenderer::CalculateViewChange(double deltaX,
                                                                                            double deltaY) {
...
>>>>>>> pr_254
                                                ...
                                                == == == = void SysStarSystemRenderer::FoundCity() {
                                                    ...
                                                    entt::entity settlement =
                                                        common::actions::CreateCity(planetnode, s);
                                                    // Set the name of the city
                                                    Name& name = m_universe.emplace<Name>(settlement);
                                                    name.name = m_universe.name_generators["Town Names"].Generate("1");
>>>>>>> pr-309
                                                    == == == = entt::entity settlement = common::actions::CreateCity(
                                                                 m_universe, on_planet, s.latitude(), s.longitude());
                                                    // Set the name of the city
                                                    Name& name = m_universe.emplace<Name>(settlement);
                                                    name.name = m_universe.name_generators["Town Names"].Generate("1");
...
<<<<<<< HEAD
                                                for (auto body : m_universe.view<Orbit, bodies::DirtyOrbit>()) {
                                                    == == == = auto orbit4 =
                                                                 m_universe.view<Orbit, bodies::DirtyOrbit>();
...
>>>>>>> pr_254
                                                    ...
                                                    for (entt::entity ship :
                                                         m_universe.view<OrbitMesh, ships::Crash>()) {
                                                ...
                                                void SysStarSystemRenderer::RenderInformationWindow(double deltaTime) {
                                                    ...
                                                    ImGui::TextFmt("Cam Pos: {} {} {}", cam_pos.x, cam_pos.y,
                                                                   cam_pos.z);
                                                    ImGui::TextFmt("View Center: {} {} {}", view_center.x,
                                                                   view_center.y, view_center.z);
...
>>>>>>> pr_254
                                                        ...
                                                        ImGui::TextFmt("Selected province color: {} {} {}",
                                                                       selected_province_color.x,
                                                                       selected_province_color.y,
                                                                       selected_province_color.z);

                                                        ImGui::TextFmt("Hovered province color: {} {} {}",
                                                                       hovering_province_color.x,
                                                                       hovering_province_color.y,
                                                        ...
                                                        ImGui::TextFmt("Generated {} orbits last frame",
                                                                       orbits_generated);
<<<<<<< HEAD
...
>>>>>>> pr_254
                                                    ...
                                                    void SysStarSystemRenderer::RenderSelectedObjectInformation() {
                                                        ...
                                                        ImGui::SetNextWindowPos(
                                                            ImVec2(ImGui::GetIO().DisplaySize.x - 200,
...
>>>>>>> pr_254
                                                                ...
                                                                ImGui::TextFmt("Prograde vector: {} {} {}", norm.x,
                                                                               norm.y, norm.z);
...
>>>>>>> pr_254
                                                                    ...
                                                                    s = SurfaceCoordinate(s.latitude(),
                                                                                          s.longitude() + 90);
                                                                    return s;
                                                                }
                                                                ...
                                                                void SysStarSystemRenderer::CityDetection() {
                                                                    ...
                                                                    int y = tex_y = fmod(s.longitude() + 180, 360) /
                                                                                    360. * _province_width;
...
>>>>>>> pr_254
                                                                    ...
                                                                    void SysStarSystemRenderer::GenerateOrbit(
                                                                        entity body) {
                                                                        // Then produce orbits
                                                                        ZoneScoped;
                                                                        // Generate the orbit
                                                                        ...
                                                                        if (m_universe.valid(orb.reference_body)) {
                                                                            SOI =
                                                                                m_universe.get<Body>(orb.reference_body)
                                                                                    .SOI;
                                                                        }
...
>>>>>>> pr_254
                                                                            ...
                                                                            void
                                                                            SysStarSystemRenderer::DrawAllOrbits() {
                                                                                ZoneScoped;
<<<<<<< HEAD
...
<<<<<<< HEAD
                                                                                    void
                                                                                    SysStarSystemRenderer::DrawOrbit(
