...
void SysPlanetMarketInformation::MarketInformationTooltipContent(const entt::entity marketentity) {
    ...
    if (ImGui::BeginTable("marketinfotable", 8, ImGuiTableFlags_Borders | ImGuiTableFlags_RowBg)) {
        ...
        for (entt::entity good_entity : goodsview) {
            ...
            if (GetUniverse().any_of<cqspc::Capital>(good_entity)) {
                ...
                ImGui::TextFmt("{}", GetUniverse().get<cqspc::Identifier>(good_entity).identifier);
            }
