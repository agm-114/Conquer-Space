...
void CQSPRenderInterface::RenderGeometry(Rml::Vertex* vertices, int num_vertices, int* indices, int num_indices,
...
Rml::CompiledGeometryHandle CQSPRenderInterface::CompileGeometry(Rml::Vertex* vertices, int num_vertices, int* indices,
...
bool CQSPRenderInterface::LoadTexture(Rml::TextureHandle& texture_handle, Rml::Vector2i& texture_dimensions,
...
bool CQSPRenderInterface::GenerateTexture(Rml::TextureHandle& texture_handle, const Rml::byte* source,
    ...
    asset::TextureLoadingOptions options;
    asset::CreateTexture(*texture, (unsigned char*)(source), source_dimensions.x, source_dimensions.y, 4, options);
    texture_handle = (Rml::TextureHandle)texture;
    return true;
}
