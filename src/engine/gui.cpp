...
namespace ImPlot {
template IMPLOT_API void PlotPieChart<float>(std::map<std::string, float>& map, double x, double y, double radius,
                                             bool normalize, const char* fmt, double angle0);
template IMPLOT_API void PlotPieChart<double>(std::map<std::string, double>& map, double x, double y, double radius,
                                              bool normalize, const char* fmt, double angle0);
template IMPLOT_API void PlotPieChart<int>(std::map<std::string, int>& map, double x, double y, double radius,
                                           bool normalize, const char* fmt, double angle0);

inline void RenderPieSlice(ImDrawList& DrawList, const ImPlotPoint& center, double radius, double a0, double a1,
                           ImU32 col) {
...
template <typename T>
IMPLOT_API void PlotPieChart(std::map<std::string, T>& map, double x, double y, double radius, bool normalize,
    ...
    for (auto it = map.begin(); it != map.end(); ++it) {
        double percent = normalize ? static_cast<double>(it->second) / sum : static_cast<double>(it->second);
