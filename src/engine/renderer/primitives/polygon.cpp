...
#include "common/components/orbit.h"
    ...
    void
    conquerspace::primitive::CreateFilledCircle(conquerspace::engine::Mesh& mesh, int segments) {
    == == == = void conquerspace::primitive::CreateFilledCircle(conquerspace::engine::Mesh & mesh, int segments) {
>>>>>>> pr_8
